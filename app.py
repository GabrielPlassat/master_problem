...
à chaque niveau, on identifie si la cause est un **Flux**, une **Structure** ou une **Règle**.
...
""")
    ...
    with st.expander("📖 Comprendre les 3 types de causes — définitions et exemples"):
        st.markdown("""
#### 📊 Flux — *Ce qui circule dans le système*

Un flux, c'est tout ce qui **se déplace, s'échange ou se transforme** : de l'argent, de l'information, 
de l'énergie, des personnes, des données, de la matière. Agir sur un flux, c'est agir sur un tuyau — 
c'est souvent le levier le plus visible, mais rarement le plus puissant.

| Domaine | Exemple de flux |
|---------|----------------|
| 🌿 Agriculture | Les subventions PAC versées aux exploitations en fonction du volume produit |
| 🏥 Santé | Le flux de patients orientés vers les urgences faute de médecins de ville |
| 🏙️ Mobilité | Le flux de voitures vers les centres-villes aux heures de pointe |
| 🏫 Éducation | Le flux d'élèves orientés vers des filières professionnelles après l'échec au collège |
| ⚡ Énergie | Le flux d'électricité centralisé depuis les grandes centrales vers les territoires |

---

#### 🏗️ Structure — *Ce qui organise et contraint les flux*

Une structure, c'est une **organisation physique, institutionnelle ou relationnelle** 
qui détermine quels flux sont possibles et dans quel sens. Agir sur une structure, c'est 
reconfigurer les canaux — plus difficile, mais plus durable qu'agir sur les flux seuls.

| Domaine | Exemple de structure |
|---------|---------------------|
| 🌿 Agriculture | Les coopératives qui imposent l'achat d'intrants chimiques comme condition de collecte |
| 🏥 Santé | La géographie des déserts médicaux : l'absence de cabinets dans les zones rurales |
| 🏙️ Mobilité | La forme urbaine étalée qui rend la voiture structurellement indispensable |
| 🏫 Éducation | Le système de notation sur 20 qui hiérarchise plutôt que de mesurer les compétences |
| ⚡ Énergie | Le réseau électrique conçu pour la distribution centralisée, pas pour l'injection locale |

---

#### 📜 Règle / Paradigme — *Ce qui légitime et perpétue les structures*

Une règle ou un paradigme, c'est une **norme, une loi, une croyance ou un modèle mental** 
qui justifie pourquoi les structures et les flux sont organisés ainsi. C'est le levier 
le plus puissant — et le plus difficile à changer, car il est souvent invisible.

| Domaine | Exemple de règle ou paradigme |
|---------|-------------------------------|
| 🌿 Agriculture | *"Un bon agriculteur maximise ses rendements"* — croyance qui rend illégitime de produire moins mais mieux |
| 🏥 Santé | *"La médecine curative est plus valorisée (et rémunérée) que la prévention"* |
| 🏙️ Mobilité | *"La voiture individuelle est un droit et un marqueur de liberté"* |
| 🏫 Éducation | *"L'intelligence se mesure par la capacité à réussir des examens standardisés"* |
| ⚡ Énergie | *"L'énergie doit être bon marché et disponible à la demande — son coût écologique est externalisé"* |

---
**💡 Clé de lecture :** En remontant vos 5 Pourquoi, vous devriez passer naturellement 
de Flux → Structure → Règle. Si vous restez au niveau des flux, vous n'avez pas encore 
atteint la cause racine.
""")
...
""")
    ...
    with st.expander("📖 Qu'est-ce qu'une tension ? — Définition et exemples dans plusieurs domaines"):
        st.markdown("""
Une **tension** n'est pas un simple désaccord entre deux personnes. C'est une opposition 
structurelle entre **deux logiques qui ont chacune leur légitimité** — et qui ne peuvent pas, 
dans le système actuel, être satisfaites simultanément.

Il existe trois types de tensions, aux implications très différentes :

---

#### 🔴 Vraie contradiction — *les deux sont incompatibles dans le système actuel*
Les deux logiques s'excluent mutuellement. Satisfaire l'une revient à sacrifier l'autre. 
Il faudra choisir, ou transformer le système pour lever l'incompatibilité.

| Domaine | Tension | Pourquoi c'est une vraie contradiction |
|---------|---------|---------------------------------------|
| 🌿 Alimentation | Production à bas coût ↔ Rémunération juste des agriculteurs | Dans la structure actuelle de la grande distribution, les deux ne peuvent coexister |
| 🏥 Santé | Médecine curative rentable ↔ Prévention efficace | Les deux se financent sur les mêmes budgets et la prévention n'est pas valorisée |
| 🏙️ Urbanisme | Densification urbaine ↔ Préservation des espaces verts intra-muros | À superficie constante, le sol ne peut être à la fois bâti et végétalisé |
| 🏭 Industrie | Croissance du volume produit ↔ Réduction des émissions sans compensation | Dans la plupart des secteurs industriels aujourd'hui, pas encore de découplage prouvé |

---

#### 🟡 Fausse dichotomie — *les deux sont peut-être compatibles si on recadre*
La tension semble irréductible mais ce n'est qu'une apparence — souvent entretenue 
par des acteurs qui bénéficient de l'opposition. Un changement de cadre ou d'échelle 
peut révéler leur compatibilité.

| Domaine | Tension apparente | Pourquoi c'est une fausse dichotomie |
|---------|------------------|-------------------------------------|
| 🌿 Agriculture | Rentabilité économique ↔ Pratiques agroécologiques | Les études sur 10 ans montrent que l'agroécologie est rentable — mais pas dans les 2 premières années |
| 🏫 Éducation | Exigence académique ↔ Bien-être des élèves | Les pays avec les meilleurs résultats PISA (Finlande, Estonie) ont aussi les élèves les moins stressés |
| 🏙️ Mobilité | Économie locale commerciale ↔ Piétonisation des centres-villes | Les villes qui ont piétonnisé ont vu leur chiffre d'affaires commercial augmenter |
| ⚡ Énergie | Emploi dans les énergies fossiles ↔ Transition énergétique | Les emplois dans les renouvelables dépassent déjà ceux des fossiles dans de nombreux pays |

---

#### 🟢 Tension créative — *la friction elle-même est productive*
Les deux logiques s'opposent, mais cette opposition génère de l'énergie, de l'innovation 
ou une qualité qu'aucune des deux ne pourrait atteindre seule. Il ne faut pas résoudre 
la tension — il faut l'habiter et la faire travailler.

| Domaine | Tension | Ce qu'elle produit |
|---------|---------|-------------------|
| 🌿 Territoire | Savoir local des agriculteurs ↔ Recherche scientifique agronomique | L'agronomie participative, qui produit des savoirs hybrides plus robustes |
| 🎨 Design | Contraintes budgétaires serrées ↔ Ambition créative | L'innovation frugale, qui trouve des solutions élégantes avec peu de ressources |
| 🏛️ Gouvernance | Urgence de la décision ↔ Légitimité démocratique | La démocratie délibérative, qui accélère l'acceptabilité des décisions difficiles |
| 🌍 International | Souveraineté nationale ↔ Coopération climatique | Les accords à géométrie variable qui créent des coalitions progressivement élargies |

---
**💡 Méthode :** Commencez par nommer les deux pôles sans chercher à les hiérarchiser. 
Puis demandez-vous : *"Cette tension existe-t-elle parce que le système est mal conçu, 
ou parce que la réalité est fondamentalement paradoxale ?"*
""")
...
""")
    ...
    with st.expander("📖 Comment noter de 1 à 5 ? — Guide de lecture de la grille"):
        st.markdown("""
La grille utilise une échelle de **1 à 5** pour chaque critère. Voici comment interpréter chaque niveau :

| Note | Signification générale | Ce que ça veut dire concrètement |
|------|----------------------|----------------------------------|
| **1** | ❌ Absent ou très insuffisant | Ce critère n'est pas du tout satisfait. Le problème tel que formulé est bloqué sur cette dimension. |
| **2** | ⚠️ Faible — à retravailler | Des éléments existent mais sont trop flous, trop larges ou trop contradictoires pour être utiles. |
| **3** | 🔶 Moyen — acceptable mais perfectible | Le critère est partiellement satisfait. Suffisant pour explorer, insuffisant pour convaincre ou décider. |
| **4** | ✅ Bon — solide | Le critère est bien satisfait. Quelques points de précision à apporter mais la base est saine. |
| **5** | 🌟 Excellent — exemplaire | Ce critère est un point fort de votre formulation. Il pourrait servir d'exemple ou de point d'ancrage. |

---

**⚠️ Attention aux deux pièges classiques :**
- **Surévaluer par confort** : noter 4 ou 5 parce que le problème *nous* semble clair, alors qu'il ne l'est pas pour les autres parties prenantes.
- **Chercher le 5/5 partout** : un problème bien formulé a souvent des scores déséquilibrés — c'est normal et informatif. Un 2 sur "Faisabilité" n'invalide pas le problème, il indique où concentrer l'effort.

**💡 Conseil :** Si vous hésitez entre deux notes, choisissez la plus basse — c'est l'écart à combler qui est utile, pas le score total.
""")
    ...
    criteria = [
        (
            ...
            "1 = impact négligeable ou très local  |  3 = impact réel mais limité à un territoire ou une organisation  |  5 = impact transformateur à grande échelle, mesurable"
        ),
        (
            "🔧", "Faisabilité",
            "Peut-on définir une première étape concrète et réalisable avec les ressources disponibles ?",
            "1 = aucune première étape identifiable, le problème est trop vaste  |  3 = une piste existe mais nécessite des ressources non disponibles  |  5 = une première action est identifiée, faisable maintenant, avec ce qu'on a"
        ),
        (
            "💬", "Clarté & Engagement",
            "Le problème est-il formulé sans ambiguïté, de façon à susciter l'adhésion émotionnelle des parties prenantes ?",
            "1 = jargon technique incompréhensible pour les non-experts  |  3 = compréhensible mais ne suscite pas d'adhésion émotionnelle  |  5 = tout le monde comprend en 30 secondes et se sent concerné"
        ),
        (
            ...
            "1 = impossible de savoir si on progresse  |  3 = des indicateurs existent mais sont difficiles à mesurer ou contestés  |  5 = indicateurs clairs, mesurables, et hypothèses testables à court terme"
        ),
        (
            "🧭", "Alignement Stratégique",
            "Le problème s'inscrit-il dans une vision à long terme et les objectifs globaux de l'organisation ou du territoire ?",
            "1 = déconnecté de toute stratégie ou vision partagée  |  3 = lien avec la stratégie existe mais n'est pas explicite  |  5 = ancré dans une North Star claire, des engagements formels (PCAET, ODD, plan stratégique)"
        ),
        (
            ...
            "1 = toute action engage des ressources importantes et irréversibles  |  3 = possible de revenir en arrière mais coûteux  |  5 = les premières expériences sont petites, rapides, sûres à échouer et riches d'apprentissage"
        ),
    ]
